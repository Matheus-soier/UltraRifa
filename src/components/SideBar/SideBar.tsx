...
export const SideBar = () => {
   ...
   useEffect(() => {
    ...
    return(
        <div className={`${useCtx.expanded ? "left-0" : "left-[-300px]"} fixed side-bar bg-white w-[280px] h-full mt-16 flex flex-col border-r md:hidden transition-all ease-in-out`}>
