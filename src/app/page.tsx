...
import { GridMainNumber } from "@/components/GridItemNumber";
    ...
    <div className="mt-20 md:mt-28 w-screen flex flex-col items-center px-3">
      ...
      <section className="max-w-screen-xl flex flex-col items-center gap-6 mb-10 md:mb-20 w-full h-fit px-3">
        <div className="space-y-5 w-full text-center">
          <h2 className="font-bold text-center text-3xl md:text-5xl capitalize">Veja como é simples.</h2>
      ...
      <section className="max-w-screen-xl flex flex-col items-center gap-6 md:gap-12 mb-10 md:mb-24 w-full h-fit px-3">
        <h2 className="font-bold text-center text-3xl md:text-5xl capitalize">Dúvidas Frequentes</h2>
